...
namespace MercadoEnvio.DAO
{
    class PublicacionSQL
    {
        ...
        internal static void crearComprar(int idPublicacion, int idCliente, int cantidad)
        {
            SqlConnector.executeProcedure("crearCompra", idPublicacion, idCliente, cantidad);  
        }
    }
}

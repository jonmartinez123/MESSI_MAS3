...
AS
BEGIN
	SELECT rol_nombre FROM MESSI_MAS3.Rol_Usuario,MESSI_MAS3.Rol WHERE Usuario_id=@id AND MESSI_MAS3.Rol_Usuario.Rol_id = MESSI_MAS3.Rol.rol_id AND rol_deleted=0
END
GO
